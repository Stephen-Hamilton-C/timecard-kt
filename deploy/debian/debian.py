...
def generateChangelog():
	print("Generating changelog from CHANGELOG.md...")
...
def generateCopyright():
	print("Generating copyright from CREDITS.md...")

	# Setup Copyright constants
	COPYRIGHT_HEADER = "Copyright GNU GPL 3.0 2022 Stephen Hamilton <stephen.hamilton.c@gmail.com>\nSee /usr/share/common-licenses/GPL-3 for full license\n\n"
	CREDITS = "CREDITS.md"
	DEB_COPYRIGHT = os.path.join("deploy", "debian", "debian", "copyright")

	fileLines = []
	with open(CREDITS, 'r') as file:
		fileLines = file.readlines()
		
	with open(DEB_COPYRIGHT, 'w') as file:
